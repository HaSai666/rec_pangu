...
from rec_pangu.models.sequence import (ComirecSA, ComirecDR, MIND, CMI, Re4,
                                       NARM, YotubeDNN, SRGNN, GCSAN, SASRec, NISER)
...
if __name__=='__main__':
    ...
    model = NISER(enc_dict=enc_dict,config=config)
    #声明Trainer
